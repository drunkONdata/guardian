...
# Video Anlytics via Rekognition Video API
...
class VideoDetect:
    ...
    # Gets the results of labels detection by calling GetLabelDetection.
    # Label detection is started by a call to StartLabelDetection.
